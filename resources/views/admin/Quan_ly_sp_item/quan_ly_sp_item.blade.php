            ...
            <tbody>
              @foreach ($items as $item)
                <tr>
                    ...
                    <th class="text-center">{{$item->loai_vat_pham->gia}}<span style="font-size: 15px">₫</span></th>
      ...
      <div class="modal-body">
        <form action="{{url('sua_item')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input name="up_ten_item" type="text" class="form-control" id="up_ten_item" value="{{$item->ten_vat_pham}}" required>
          </div>
          <div class="form-group">
