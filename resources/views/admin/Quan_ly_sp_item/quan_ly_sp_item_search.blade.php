            ...
            <tbody>
              @foreach ($tim_kiems as $tim_kiem)
                <tr>
                    ...
                    <th class="text-center">{{$tim_kiem->loai_vat_pham->gia}}</th>
      ...
      <div class="modal-body">
        <form action="{{url('sua_item')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input name="up_ten_item" type="text" class="form-control" id="up_ten_item" {{$empty!=1?"value=$tim_kiem->ten_vat_pham":""}}>
          </div>
          <div class="form-group">
