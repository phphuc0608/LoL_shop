...
Route::get('quan_ly_danh_sach_tuong_search/{page}/{keyword}', [\App\Http\Controllers\Danh_sach_tuong_controller::class, 'view_quan_ly_danh_sach_tuong_search'])->name('quan_ly_danh_sach_tuong_search');
Route::get('tim_kiem_process', [\App\Http\Controllers\Danh_sach_tuong_controller::class, 'xu_ly_tim_kiem'])->name('tim_kiem_tuong');
//them sua xoa
